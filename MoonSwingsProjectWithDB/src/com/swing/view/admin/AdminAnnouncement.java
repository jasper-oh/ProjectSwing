...
import com.swing.model.admin.AdminAnnouncementDbAction;
import com.swing.model.admin.beans.AdminAnnouncementBean;
import com.swing.view.common.FindIdPw;
public class AdminAnnouncement extends JPanel {
	...
	public void searchAction(){
        AdminAnnouncementDbAction dbAction = new AdminAnnouncementDbAction();
        ArrayList<AdminAnnouncementBean> beanList = dbAction.selectAnnouncementList();
	...
	private void TableClick() {
		...
		AdminAnnouncementDbAction dbAction = new AdminAnnouncementDbAction(wkNo);		
		AdminAnnouncementBean bean = dbAction.TableClick();
	...
	private void clickCount() {
		...
		AdminAnnouncementDbAction dbAction = new AdminAnnouncementDbAction(wkNo, wkViews);
		dbAction.clickCount();           
	}
