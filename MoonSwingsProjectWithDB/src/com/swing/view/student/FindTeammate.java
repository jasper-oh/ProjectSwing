package com.swing.view.student;
...
import com.swing.model.student.FindTeammateDbAction;
import com.swing.model.student.FindTeammateDbAction2;
import com.swing.model.student.FindTeammateDbAction3;
import com.swing.model.student.beans.FindTeammateBean;
import com.swing.view.admin.AdminStudentProfile;
...
public class FindTeammate extends JPanel {
	...
	public FindTeammateDbAction2 dbAction = new FindTeammateDbAction2();
...
//			btnDelete.setEnabled(false);
	...
	public void searchAction(){
        ...
        FindTeammateDbAction3 dbAction = new FindTeammateDbAction3(loginedId);
        ArrayList<FindTeammateBean> beanFTList = dbAction.selectStudentList();
	...
	private void searchTeamStatus(String selection) {
        FindTeammateDbAction dbAction = new FindTeammateDbAction(selection);
        
        ArrayList<ArrayList<FindTeammateBean>> beanList = dbAction.selectSearchTeamStatusList();
        ArrayList<FindTeammateBean> beanFTList = beanList.get(1);
        ArrayList<FindTeammateBean> beanUnteamedList = beanList.get(0);
	...
	private void ConditionQueryAction(String ConditionQueryColumn, String selection) {
		...
		FindTeammateDbAction dbAction = new FindTeammateDbAction(ConditionQueryColumn, selection);
		ArrayList<FindTeammateBean> beanFTList = dbAction.ConditionQueryAction();
		int listCount = beanFTList.size();
...
//	String testId = "ohoh9900"; // 병합 후 삭제할 변수 !!!!!!!!!!
	...
	public void showYouPickedby(){
        ...
        FindTeammateDbAction2 dbAction = new FindTeammateDbAction2(loginedId); // login id로 보내기************
        ArrayList<FindTeammateBean> beanPickedList = dbAction.selectYouPickedByList();
	...
	public void showMyPick(){
        ...
        FindTeammateDbAction2 dbAction = new FindTeammateDbAction2(loginedId); // login id로 보내기************
        ArrayList<FindTeammateBean> beanMyPickList = dbAction.selectMyPickList();
	...
	private void deleteMyPick() {
		...
		if(!clickId.equals("")) {
			FindTeammateDbAction2 dbAction = new FindTeammateDbAction2(loginedId, clickId);
