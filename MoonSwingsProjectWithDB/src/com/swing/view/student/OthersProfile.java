...
import com.swing.model.student.CheckProfileDBAction;
import com.swing.model.student.FindTeammateDbAction2;
import com.swing.model.student.beans.CheckProfileBean;
...
// Student Profile Project and teammate review table
	...
	private void setText() {
		...
		FindTeammateDbAction2 dbAction = new FindTeammateDbAction2(tfStudentId.getText());
		FindTeammateBean bean = dbAction.TableClick();
...
//		String loginedId = mp.lblId();
		FindTeammateDbAction2 dbAction = new FindTeammateDbAction2(Login.tfLoginUserId.getText(), id); // testLogin id change to Login Id***
...
//	 */
	private void checkDipAction() {
		...
		FindTeammateDbAction2 dbAction = new FindTeammateDbAction2();
		ArrayList<FindTeammateBean> beanDipList = dbAction.checkDipList();
	...
	public void showStudentProject(){
		...
		FindTeammateDbAction2 dbAction  = new FindTeammateDbAction2(id);
		ArrayList<FindTeammateBean> projectList = dbAction.selectStudentProjectList();
	...
	public void showTeammateReview(){
		...
		ArrayList<FindTeammateBean> teamReviewList = dbAction.selectStudentReviewList();
